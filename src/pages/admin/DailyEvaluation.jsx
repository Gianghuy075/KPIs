...
import { EditOutlined, DeleteOutlined, CheckOutlined, MinusOutlined } from '@ant-design/icons';
...
const DailyEvaluation = () => {
  const [evaluations, setEvaluations] = useState([
    { 
      id: 1, 
      date: '2024-04-01', 
      task: 'Kiểm tra hệ thống', 
      assignee: 'Nguyễn Văn A',
      fullScore: 100,
      deductedScore: 5,
      finalScore: 95,
      comment: 'Hoàn thành đúng hạn'
    },
    { 
      id: 2, 
      date: '2024-04-02', 
  ...
  return (
    <div>
      <Card title="Quản lý Đánh giá Công việc Hàng ngày">
      ...
      <Modal
        title={editingEval ? 'Chỉnh sửa đánh giá' : 'Thêm đánh giá công việc hàng ngày'}
        open={modalOpen}
        onCancel={() => {
          setModalOpen(false);
          form.resetFields();
