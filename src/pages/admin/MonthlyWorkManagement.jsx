...
const MonthlyWorkManagement = () => {
  const [works, setWorks] = useState([
    { id: 1, month: 'Tháng 1', task: 'Lập kế hoạch Q1', department: 'Ban Lãnh đạo', status: 'Hoàn thành' },
    { id: 2, month: 'Tháng 1', task: 'Kiểm tra hệ thống', department: 'Kỹ thuật', status: 'Đang thực hiện' },
  ]);
  ...
  return (
    <Card title="Quản lý Công việc Hàng tháng" extra={
      ...
      <Modal
        title={editingWork ? 'Chỉnh sửa công việc' : 'Thêm công việc hàng tháng'}
        open={modalOpen}
        onCancel={() => {
          setModalOpen(false);
          form.resetFields();
...
export default MonthlyWorkManagement;
